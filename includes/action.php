...
if(isset($_POST["submit"])) {    							 //clicking submit button inside Add form will redirect in this function 
	...
	if($obj->insert_record("tbl_products",$myArray)) {        //if insert_record method inside class is true  
...
if(isset($_POST["edit"])) {
	...
	if($obj->update_record("tbl_products",$where,$myArray)) {
...
if(isset($_GET["delete"])) {
	$id = $_GET["id"] ?? null;
	$where = array("id"=>$id);
	if($obj->delete_record("tbl_products",$where)) {
